...
object Constants {
    ...
    val DOUBLE_DASHES = "===================================="
    val NAME_COUNT_PRICE = "상품명\t\t수량\t금액"
    val RECEIPT_FORMAT_WITH_COUNT = "%s\t\t%d \t%,d"
    val RECEIPT_FORMAT_PRESENTS = "%s\t\t%d"
    val RECEIPT_FORMAT_TOTAL_PRICE = "총구매액\t\t%d\t%,d"
    val RECEIPT_FORMAT_PROMOTION_PRICE = "행사할인\t\t\t%,d"
    val RECEIPT_FORMAT_MEMBERSHIP_PRICE = "멤버십할인\t\t\t%,d"
    val RECEIPT_FORMAT_RESULT_PRICE = "내실돈\t\t\t %,d"
    val DASH = "-"
